            ...
            <Layout>
                <main class="p-4 mx-auto max-w-screen-md">
                    ...
                    <p>1944 yılında Ankara'da doğdum. İlk Orta Lise eğitimimi TED Ankara
                        ...
                        eğitmen ve sistem kurucu olarak çalışmaya başladım.</p><br>

                        <p>Günümüze dek yüze yakın Küçük Orta boy işletmelere sistemler kurdum,
                            uygulamalarını yazdım, elemanlarını eğittim.Çeşitli Vakıf
                            Üniversitelerinde dersler verdim.</p></br>

                    <p>İlgi alanlarım: bilim / teknoloji, kişisel gelişim, spritüel çalışmalar,
